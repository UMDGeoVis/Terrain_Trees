...
//     this->build_persistence_queue(ig,mesh,persistence); /// add a subset of the arcs of the local MIG
...
//     simplify(n,mesh,gradient,ig,local_rels, cache,root,division,persistence);
// }

// void Forman_Gradient_Simplifier::simplify(Node_V &n, Mesh &mesh, Forman_Gradient &gradient, IG& ig, local_VTstar_ET &local_rels,
...
// void Forman_Gradient_Simplifier::contraction(nNode *extrema, iNode *saddle, IG &ig, Mesh &mesh, Forman_Gradient &gradient,
...
// void Forman_Gradient_Simplifier::removal(nNode *extrema, iNode *saddle,  IG &ig, Mesh &mesh, Forman_Gradient &gradient,
...
// void Forman_Gradient_Simplifier::build_persistence_queue( IG &ig, Mesh &mesh, coord_type persistence)
// {
//     for(int i=0; i<2; i++)
//     {
